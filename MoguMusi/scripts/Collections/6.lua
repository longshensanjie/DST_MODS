local KEYBOARDTOGGLEKEY = GetModConfigData("biaoqing_KEYBOARDTOGGLEKEY") or 103
local SCALEFACTOR = GetModConfigData("biaoqing_SCALEFACTOR") or 1
...
local ONLYEIGHT = false
local EIGHTS = {"wave", "dance", "happy", "bonesaw", "rude", "facepalm", "sad", "kiss"}
